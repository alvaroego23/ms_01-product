...
export class ProductoCategoriaController {
  ...
  async find(
    ...
    return this.productoRepository.tiene_categoria(id).find(filter);
  }
  ...
  async create(
    ...
    return this.productoRepository.tiene_categoria(id).create(categoria);
  }
  ...
  async patch(
    ...
    return this.productoRepository.tiene_categoria(id).patch(categoria, where);
  }
  ...
  async delete(
    ...
    return this.productoRepository.tiene_categoria(id).delete(where);
  }
}
