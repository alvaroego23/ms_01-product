...
export class MarcaProductoController {
  ...
  async find(
    ...
    return this.marcaRepository.tiene_mucho_producto(id).find(filter);
  }
  ...
  async create(
    ...
    return this.marcaRepository.tiene_mucho_producto(id).create(producto);
  }
  ...
  async patch(
    ...
    return this.marcaRepository.tiene_mucho_producto(id).patch(producto, where);
  }
  ...
  async delete(
    ...
    return this.marcaRepository.tiene_mucho_producto(id).delete(where);
  }
}
